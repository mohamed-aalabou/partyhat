...
from agents.agent_registry import AGENTS, get_agent_for_intent


def test_coding_tools_can_be_imported():
    # Sanity check that coding tools and storage abstractions import cleanly.
    from agents import coding_tools  # noqa: F401
    from agents.code_storage import LocalCodeStorage  # noqa: F401


def test_deployment_tools_can_be_imported():
    from agents import deployment_tools  # noqa: F401
